...
- Our project now runs on a volunteer basis, still linked to Jersey's [Legislative Drafting Office](https://www.gov.je/Government/NonexecLegal/StatesGreffe/LegislativeDraftingOffice/Pages/index.aspx){:target="_blank"} ("LDO"). For more on legislative drafting and LDO, see **our page on [what legislative drafting is](/about/legislative-drafting)** and how it operates in Commonwealth countries.
...
- Other streams of the project include -
  - producing **non-technical** [guidance and training](/work/guidance-for-drafters) material for legislative drafters on what we have learnt about drafting itself,
...
- For more on the **range of views** that others in the field take on what they mean by "Rules as Code", and how CRLP's view fits into that range, see **our [Rules as Code](/about/rulesascode) page**. For what is distinctive about CRLP's approach, see our **[CRLP focus](/about/focus-CRLP)** page.
