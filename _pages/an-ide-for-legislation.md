...
In separate but related work, we are developing a tool to enable drafters in Jersey to add mark-up to generate **pop-ups** from **defined** terms, to show the **text of the definition** with a **link** back to wherever the definition provision sits. For background, see our [presentation video](https://youtu.be/zq6mf2zz7Eg?list=PLxI6pLSZVXTqp-BZ2f3uQ3m-mFp2nP4br&t=200){:target="_blank"} and [newsletter item](https://digitallegislation.substack.com/i/158221711/using-hyperlinks-more-fully-ids-x-refs-definitions){:target="_blank"}.
